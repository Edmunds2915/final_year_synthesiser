...
// calculateMultiplier function adapted by me
// -----------------------------------------------------------------------------------
...
void EnvelopeGenerator::calculateMultiplier (double startLevel, double endLevel,
...
void EnvelopeGenerator::setStageValue (EnvelopeStage stage, double value)
{
			...
			currentStage == ENVELOPE_STAGE_RELEASE) 
		{
			...
			switch (currentStage)
			{
				...
				case ENVELOPE_STAGE_DECAY:
					nextLevelValue = jmax(stageValue[ENVELOPE_STAGE_SUSTAIN], minimumLevel);
					break;
	...
	if (currentStage == ENVELOPE_STAGE_DECAY && stage == ENVELOPE_STAGE_SUSTAIN)
	{
		...
		calculateMultiplier(currentLevel,
			jmax(stageValue[ENVELOPE_STAGE_SUSTAIN], minimumLevel),
